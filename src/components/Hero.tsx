          ...
          /> */}
                <div className="relative mt-4 flex flex-col px-4 py-4  md:px-4 md:pl-8 w-full sm:mt-0 max-w-full">
                    ...
                    <p className="text-sm text-black sm:text-lg">
                        A fullstack web3 developer with a passion for problem-solving and creating
                        efficient, user-friendly decentralized applications. Check some of my recents projects below.
                    </p>
                </div>
            </div>
        </section>
